...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','pythonInterpreter.py',111),
  ('statement -> expression','statement',1,'p_statement_expr','pythonInterpreter.py',116),
  ...
  ('expression -> expression / expression','expression',3,'p_expression_binop','pythonInterpreter.py',124),
  ('expression -> - expression','expression',2,'p_expression_uminus','pythonInterpreter.py',136),
  ('expression -> ( expression )','expression',3,'p_expression_group','pythonInterpreter.py',141),
  ('expression -> NUMBER','expression',1,'p_expression_number','pythonInterpreter.py',145),
  ('expression -> STRING','expression',1,'p_expression_string','pythonInterpreter.py',149),
  ('expression -> LINE_COMMENT','expression',1,'p_expression_line_comment','pythonInterpreter.py',153),
  ('expression -> POINT','expression',1,'p_expression_point','pythonInterpreter.py',156),
  ('expression -> EQ','expression',1,'p_expression_eq','pythonInterpreter.py',160),
  ('expression -> NEQ','expression',1,'p_expression_neq','pythonInterpreter.py',164),
  ('expression -> GT','expression',1,'p_expression_gt','pythonInterpreter.py',168),
  ('expression -> GET','expression',1,'p_expression_get','pythonInterpreter.py',172),
  ('expression -> LT','expression',1,'p_expression_lt','pythonInterpreter.py',176),
  ('expression -> LET','expression',1,'p_expression_let','pythonInterpreter.py',180),
  ('expression -> INPUT','expression',1,'p_expression_input','pythonInterpreter.py',184),
  ('expression -> PRINT','expression',1,'p_expression_print','pythonInterpreter.py',188),
  ('expression -> IF','expression',1,'p_expression_if','pythonInterpreter.py',192),
  ('expression -> ELSE','expression',1,'p_expression_else','pythonInterpreter.py',196),
  ('expression -> WHILE','expression',1,'p_expression_while','pythonInterpreter.py',200),
  ('expression -> NAME','expression',1,'p_expression_name','pythonInterpreter.py',204),
]
