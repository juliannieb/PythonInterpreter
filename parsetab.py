...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','pythonInterpreter.py',53),
  ('statement -> expression','statement',1,'p_statement_expr','pythonInterpreter.py',58),
  ('expression -> expression + expression','expression',3,'p_expression_binop','pythonInterpreter.py',63),
  ('expression -> expression - expression','expression',3,'p_expression_binop','pythonInterpreter.py',64),
  ...
  ('expression -> - expression','expression',2,'p_expression_uminus','pythonInterpreter.py',78),
  ('expression -> ( expression )','expression',3,'p_expression_group','pythonInterpreter.py',83),
  ('expression -> NUMBER','expression',1,'p_expression_number','pythonInterpreter.py',88),
  ('expression -> NAME','expression',1,'p_expression_name','pythonInterpreter.py',93),
]
